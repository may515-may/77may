...
import { Article, fetchArticles, createArticle, updateArticle, deleteArticle } from '../services/articleService';
export function useArticleSync() {
 ...
 const handleCreate = useCallback(async (article: Omit<Article, 'id' | 'createdAt' | 'updatedAt'>) => {
 try {
